...
class Comment(Base):
    ...
    user_id = Column(Integer, ForeignKey("users.id", name="fk_comments_users"), nullable=False)
    post_id = Column(Integer, ForeignKey("posts.id", name="fk_comments_posts"), nullable=False)
